  ...
  return (
    <div className='bg-gradient-to-bl from-[#127DF5] to-[#0B498F] min-h-[100vh] py-16'>
      <div className='w-[80%] mx-auto'>
        <h1 className='text-center pt-4 pb-10 text-2xl sm:text-3xl font-bold'>Our company projects in UI UX</h1>
        <div className='flex flex-col md:flex-row'>
          ...
          <div className='pr-0 md:pr-8 z-10 order-2 md:order-1 w-full md:w-[60%]'>
            ...
            <p className='leading-8 font-bold'>
                Our Smart Car App offers an innovative, autonomous driving experience,
                allowing users to control their vehicle without the need for a driver.
                With advanced AI and GPS technology, our app enables safe and seamless navigation,
                while providing features like route optimization, real-time tracking, and remote control.
                Whether you're looking to get from one place to another or simply need your car to autonomously
                handle tasks, our app provides the convenience
                and security of fully autonomous driving, ensuring a futuristic and efficient journey.
            </p>
          </div>
        </div>
      </div>
