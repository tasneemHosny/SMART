...
const Footer = () => {
  return (
    <footer className="bg-[#C4C4C4] text-black py-8">
      <div className=" mx-auto flex flex-col lg:flex-row justify-between items-center lg:items-start lg:px-20 md:px-12 sm:px-8 px-6 py-8 ">
        <div className="mb-8 lg:mb-0 flex flex-col lg:items-start">
          <div className="flex justify-center md:justify-center sm:justify-center lg:justify-start">
            <img
              className="w-40 sm:w-40 md:w-40 lg:w-52 xl:w-64 -ml-8 -mt-4"
          ...
          <div className="text-center lg:text-left">
            <h3 className="font-bold mb-5 text-xl sm:text-2xl md:text-2xl lg:text-2xl">Follow us</h3>
        ...
        <div className="text-center lg:text-left mb-8 mt-6 lg:mb-0">
          <h3 className="font-bold mb-4 text-xl sm:text-2xl md:text-2xl lg:text-2xl">Quick links</h3>
        ...
        <div className="text-center mt-6 lg:text-left">
          <h3 className="font-bold mb-4 text-xl sm:text-2xl md:text-2xl lg:text-2xl">E-mail</h3>
          <p className="mb-4">smart@gmail.com</p>
          <h3 className="font-bold mb-4 text-xl sm:text-2xl md:text-2xl lg:text-2xl">Call us</h3>
