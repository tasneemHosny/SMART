    ...
    <section className="py-16 bg-gray-50 text-center">
      ...
      <div className="flex flex-wrap justify-center gap-9">
        {services.map((service, index) => (
          <div
            key={index}
            className="relative max-w-xs md:w-auto bg-white border-2 border-[#208AB2] rounded-lg shadow-md p-6 px-4 transition-transform transform hover:scale-105 min-h-[380px]"
          >
            <div className="absolute inset-1 border-2 border-[#208AB2] rounded-lg pointer-events-none"></div>
            ...
            <p className="text-med text-gray-600 mb-6 font-nunito">{service.description}</p>

            <div className="absolute bottom-6 left-0 right-0 px-6">
              <button className="w-full bg-[#208AB2] text-white py-2 px-4 rounded-md hover:bg-[#57a2be] flex items-center justify-center gap-2">
                Enroll now
                <img
                  src={arrow}
                  alt="Arrow Icon"
